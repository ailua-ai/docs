...
description: Configure general workspace settings including name, default timezone, locale, branding, and display preferences for users across your organization.
---
