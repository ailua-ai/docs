...
description: Set up your workspace, invite teammates, and configure roles and core settings in under twenty minutes so your team can start using the platform.
---
