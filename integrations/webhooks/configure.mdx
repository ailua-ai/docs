...
description: Configure webhooks to receive real-time events. Register endpoint URLs, choose event types, verify signatures, and handle retries and failures.
---
...
<Steps>
  ...
  <Step title="Select events">
    ...
    {/* TODO: Restore link once the "event types" page is added at /integrations/webhooks/event-types. */}
