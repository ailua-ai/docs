...
description: Get started with Analytics by connecting a data source, exploring sample queries, and building your first dashboard in under fifteen minutes.
---
...
{/* TODO: Restore link once the "charts and visualizations" page is added at /analytics/dashboards/charts-visualizations. */}
